package com.epam.alexander_rybalko.java.lesson8.task3;

import java.io.File;
import java.util.Scanner;

import com.epam.alexander_rybalko.java.lesson8.task3.dish.Salad;
import com.epam.alexander_rybalko.java.lesson8.task3.vegetable.Vegetable;
import com.epam.alexander_rybalko.java.lesson8.task3.xmlParser.XMLParser;
...
public class Chef {
    ...
    public void getOptions() {
        File file = new File("src/main/resources/com/epam/alexander_rybalko/java/lesson8/task3/vegetables.xml");
                ...
                switch (choice) {
                    ...
                    case 4: {
                        ...
                        try {
                            ...
                            vegetable = XMLParser.getVegetableByXMLFile(file, nameOfVegetable);
                            if (vegetable == null) {
